...
export const fetchProjectById = (id) => async (dispatch) => {
  ...
  try {
    ...
    console.log("fetched projects by id", data);
...
export const deleteProjectById =
  ...
  async (dispatch) => {
    ...
    try {
      ...
      console.log("Deleted project by id", data);
      dispatch({ type: DELETE_PROJECT_SUCCESS, projectId: projectId });
    } catch (error) {
      console.log("error", error);
    }
  };
...
export const acceptInvitation =
  ...
  async (dispatch) => {
    ...
    try {
      ...
      console.log("accept to project by id", data);
...
export const inviteToProject =
  ...
  async (dispatch) => {
    ...
    try {
      ...
      console.log("invitation to project by id", data);
