...
export const FETCH_ISSUES_BY_ID_REQUEST = "FETCH_ISSUE_BY_ID_REQUEST";
export const FETCH_ISSUES_BY_ID_FAILURE = "FETCH_ISSUE_BY_ID_FAILURE";
export const FETCH_ISSUES_BY_ID_SUCCESS = "FETCH_ISSUE_BY_ID_SUCCESS";
