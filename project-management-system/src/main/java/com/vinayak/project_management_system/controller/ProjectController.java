...
import com.vinayak.project_management_system.request.InviteRequest;
import com.vinayak.project_management_system.response.MessageResponse;
import com.vinayak.project_management_system.service.InvitationService;
...
public class ProjectController {
    ...
    @GetMapping
    public ResponseEntity<List<Project>> getProject(@RequestParam(required = false)String category,@RequestParam(required = false)String tag,
                                                    @RequestHeader("Authorization") String jwt
                                                    )throws Exception{
        User user = userService.findUserProfileByJwt(jwt);
        List<Project> projects = projectService.getProjectByUserTagCategory(user,category,tag);
    ...
    public ResponseEntity<MessageResponse>inviteUser(
        ...
        MessageResponse messageResponse = new MessageResponse("User Invitation sent Successfully");
    ...
    public ResponseEntity<Invitation>acceptInvitation(
      ...
      projectService.addUserToProject(invitation.getProjectId(),user.getId());
        MessageResponse messageResponse = new MessageResponse("User accepted Invitation Successfully");
